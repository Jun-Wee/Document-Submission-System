<!-- Description: Analysis Management Page in PHP -->
...
if (!isset($_SESSION['admin'])) {
    if (!isset($_SESSION['convenor'])) {
        ...
        $analysis_records = $analysisTable->getAll();
    }
} else {
...
$number_of_results = count($analysis_records);
...
$analysis_records_subset = array_slice($analysis_records, $this_page_first_result, $results_per_page);
?>
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="sidebar">
                        ...
                        <li class="nav-item">
                            <a href="analysisManagement.php" class="nav-link align-middle px-0">
                                <i class="fs-2 bi bi-bar-chart-line" id="navicon-active"></i>
                                <span class="ms-1 d-none d-sm-inline" id="navtext-active">Report Analysis</span>
                            </a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="col py-3">
                ...
                <div class="row">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <?php
                            for ($i = 0; $i < count($analysis_records_subset); $i++) {
                                echo "<tr>";
                                echo "<td> " . $analysis_records_subset[$i]->getAnalysisId() . "</td>";
                ...
                for ($page = 1; $page <= $number_of_pages; $page++) {
                    if ($current_page == $page) {
                        echo "<a class='btn btn-dark' id='navtext-active' href='analysisManagement.php?page=" . $page . "'>" . $page . "</a> ";
                    } else {
                        echo "<a class='btn btn-dark' href='analysisManagement.php?page=" . $page . "'>" . $page . "</a> ";
                    }
                }
                // pagination page links --------------------------------------------------------------------------------------------------------------------
                ?>
