...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 08, 2022 at 03:41 PM
...
INSERT INTO `question` (`submissionId`, `questionNum`, `stuAnswer`, `answer`, `context`, `options`, `statement`) VALUES
(100070, 1, '', 'consumer electronics', 'Technological breakthroughs such as microprocessors, light emitting diodes(LED), and lithium-ion batteries, they are almost to be found everywhere in our modern-day consumer electronics: TVs, speakers, displays, computers, lighting, and many more. In this', 'Consumer Products,Electronics,Planned Obsolescence', 'What is it almost impossible for us to carry out our day-to-day routines without relying on?'),
(100070, 2, '', 'neodymium', 'According to Ambaye(2020), the demand for rare earth materials has increased significantly over the years because of their extensive use[1], with the commonly sourced being praseodymium, cerium, lanthanum, neodymium, samarium, and gadolinium due to their ', 'Boron,Copper,Tungsten', 'What is the most commonly sourced rare earth material?'),
(100070, 3, '', 'computers', 'Technological breakthroughs such as microprocessors, light emitting diodes(LED), and lithium-ion batteries, they are almost to be found everywhere in our modern-day consumer electronics: TVs, speakers, displays, computers, lighting, and many more.', 'Computer Hardware,Laptops,Printers', 'What is the most recent technological breakthrough in consumer electronics?'),
(100070, 4, '', 'displays', 'Technological breakthroughs such as microprocessors, light emitting diodes(LED), and lithium-ion batteries, they are almost to be found everywhere in our modern-day consumer electronics: TVs, speakers, displays, computers, lighting, and many more.', 'Displayed,Shows,Mirroring', 'What is the most common consumer electronics component?'),
(100070, 5, '', 'demand', 'According to Ambaye(2020), the demand for rare earth materials has increased significantly over the years because of their extensive use[1], with the commonly sourced being praseodymium, cerium, lanthanum, neodymium, samarium, and gadolinium due to their ', 'Supply', 'What has increased in the use of rare earth materials?'),
(100071, 1, '', 'consumer electronics', 'Technological breakthroughs such as microprocessors, light emitting diodes(LED), and lithium-ion batteries, they are almost to be found everywhere in our modern-day consumer electronics: TVs, speakers, displays, computers, lighting, and many more. In this', 'Consumer Products,Electronics,Planned Obsolescence', 'What is it almost impossible for us to carry out our day-to-day routines without relying on?'),
(100071, 2, '', 'neodymium', 'According to Ambaye(2020), the demand for rare earth materials has increased significantly over the years because of their extensive use[1], with the commonly sourced being praseodymium, cerium, lanthanum, neodymium, samarium, and gadolinium due to their ', 'Boron,Copper,Tungsten', 'What is the most commonly sourced rare earth material?'),
(100071, 3, '', 'computers', 'Technological breakthroughs such as microprocessors, light emitting diodes(LED), and lithium-ion batteries, they are almost to be found everywhere in our modern-day consumer electronics: TVs, speakers, displays, computers, lighting, and many more.', 'Computer Hardware,Laptops,Printers', 'What is the most recent technological breakthrough in consumer electronics?'),
(100071, 4, '', 'displays', 'Technological breakthroughs such as microprocessors, light emitting diodes(LED), and lithium-ion batteries, they are almost to be found everywhere in our modern-day consumer electronics: TVs, speakers, displays, computers, lighting, and many more.', 'Displayed,Shows,Mirroring', 'What is the most common consumer electronics component?'),
(100071, 5, '', 'demand', 'According to Ambaye(2020), the demand for rare earth materials has increased significantly over the years because of their extensive use[1], with the commonly sourced being praseodymium, cerium, lanthanum, neodymium, samarium, and gadolinium due to their ', 'Supply', 'What has increased in the use of rare earth materials?');
...
--
-- Table structure for table `websearchResults`
--
...
ALTER TABLE `question`
  ADD PRIMARY KEY (`submissionId`,`questionNum`);
...
--
-- Indexes for table `websearchResults`
--
ALTER TABLE `websearchResults`
...
--
-- AUTO_INCREMENT for table `websearchResults`
-- 
ALTER TABLE `websearchResults`
  MODIFY `ResultID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT;
...
--
ALTER TABLE `question`
  ADD CONSTRAINT `question_ibfk_1` FOREIGN KEY (`submissionId`) REFERENCES `submission` (`Id`);
